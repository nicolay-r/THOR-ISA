class ChainOfThoughtRuSentNE2023(object):
    ...
    def prompt_for_opinion_inferring(context, target, aspect_expr):
        ...
        prompt = new_context + f' Based on the common sense, what is the attitude of the author or another subject towards the mentioned aspect of {target}, and why?'
        return new_context, prompt

    @staticmethod
    def prompt_for_polarity_inferring(context, target, opinion_expr):
        new_context = context + f' The attitude of the author or another subject towards the mentioned aspect of {target} is ' + opinion_expr + '.'
        prompt = new_context + f' Based on such opinion, what is the sentiment attitude of the author or another subject towards {target}?'
        return new_context, prompt
